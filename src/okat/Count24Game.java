...
public class Count24Game {
    ...
    public static final List<String> easyCount(int[] curRandNums){
        Count24Game count24=new Count24Game();
    ...
    public static void main(String[] args) throws InterruptedException {
    	System.out.println("Input numbers(please use white space to seperate them): ");
    	  try{
        ...
        List<String> answerStris=easyCount(new int[]{5, 5, 5, 1});
